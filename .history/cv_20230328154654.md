...
# Code Samples
- [Given a string, detect whether or not it is a pangram. Return True if it is, False if not. Ignore numbers and punctuation.] [A machine learning model for image classification using Python and TensorFlow](https://github.com/johndoe/image-classification)